...
public class Appointment extends AppCompatActivity {
    ...
    private boolean isValidTime(){
        ...
        if(today.isChecked()){
            ...
            //Toast.makeText(Appointment.this, nowTime, Toast.LENGTH_SHORT).show();
            if(nowTime.compareTo(checkTime)>=0){
                //Toast.makeText(Appointment.this, "时间已过，预约失败", Toast.LENGTH_SHORT).show();
                return false;
            }
            else{
                return true;
            ...
            public void onClick(View view) {
                ...
                if(isValidTime()){
                    ...
                    builder.setNegativeButton("取消", new DialogInterface.OnClickListener()
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which)
                        {
                            Toast.makeText(Appointment.this, "重新选择预约信息" , Toast.LENGTH_SHORT).show();
...
//                        public void onClick(DialogInterface dialog, int which)
//                        {
//                            Toast.makeText(Appointment.this, "neutral: " + which, Toast.LENGTH_SHORT).show();
//                        }
//                    });
                    //    显示出该对话框
                    builder.show();
